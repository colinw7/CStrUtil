...
namespace CStrUtil {
  ...
  void toWords(const std::string &str, std::vector<std::string> &words, CWordDef *def);
  void addWords(const std::string &str, std::vector<std::string> &words, CWordDef *def);

  void toIntegers(const std::string &str, std::vector<int> &integers,
                  const std::string &splitters="");

  void toWords(const std::string &str, std::vector<std::string> &words,
               const std::string &splitters="");
  void addWords(const std::string &str, std::vector<std::string> &words,
                const std::string &splitters="");

  CStrWord readWord(const std::string &str, uint *pos, CWordDef *def=NULL);

  CStrWords toFields(const std::string &str, const std::string &splitters="",
